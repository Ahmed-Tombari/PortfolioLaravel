...
<div class="space-y-6 animate-fade-up">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Organize your portfolio projects into segments</p>
        </div>
    ...
    <div class="craftable-card overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr>
                        <th class="text-left w-24">ID</th>
                        <th class="text-left min-w-[200px]">Category Name</th>
                        <th class="text-left hidden md:table-cell">Slug</th>
                        <th class="text-left hidden lg:table-cell">Projects</th>
                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 mt-0.5">{{ $projectCount }} {{ Str::plural('project', $projectCount) }}</p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="{{ route('admin.category.destroy', $category->id) }}" method="POST" class="inline"
                                      x-data x-on:submit.prevent="if(confirm('Delete {{ $category->name }}? Projects in this category may be affected.')) $el.submit()">
                                    @csrf @method('DELETE')
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-20 text-center">
                            <div class="flex flex-col items-center gap-4">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-slate-800">No categories yet</h3>
                                    <p class="text-sm text-slate-400 mt-1">Create a category to start organizing your projects.</p>
                                </div>
