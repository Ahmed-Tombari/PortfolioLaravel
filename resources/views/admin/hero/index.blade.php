...
@if(!$hero)
    ...
    <div class="max-w-2xl">
        ...
        <div class="mb-6 p-4 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 flex items-start gap-3">
            ...
            <div>
                <p class="text-sm font-bold text-amber-800 mb-0.5">Hero Section Not Configured</p>
                <p class="text-sm text-amber-700/80">Your landing page currently has no hero section. Fill the form below to activate your portfolio's first impression.</p>
            </div>
        </div>
        ...
        <div class="craftable-card p-6 lg:p-8">
            <div class="flex items-center gap-3 mb-6 pb-5 border-b border-slate-100">
                ...
                <div>
                    <h3 class="text-base font-bold text-slate-800">Create Hero Section</h3>
                    <p class="text-xs text-slate-400 mt-0.5">Configure your landing page hero banner</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" class="admin-input"
                               placeholder="e.g., Creative Architect & Developer" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="subtitle" class="admin-input"
                               placeholder="e.g., Sculpting high-performance digital ecosystems">
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        <label class="aurora-label">Hero Image</label>
                        <div x-data="{ isDragging: false, fileName: null }"
                            ...
                            <p class="text-xs text-slate-400 mt-1" x-show="!fileName">PNG, JPG, WEBP — max 2MB</p>
                        </div>
...
@else
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
        <div>
            <h2 class="text-2xl font-bold text-slate-800">Hero Section</h2>
            <p class="text-sm text-slate-500 mt-1">Your landing page hero configuration</p>
        </div>
        ...
        <div class="xl:col-span-2">
            <div class="craftable-card overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
                    ...
                    <h3 class="text-sm font-bold text-slate-700">Active Configuration</h3>
                </div>
                <div class="divide-y divide-slate-50">
                    @php
                        $fields = [
                            ['label' => 'Title', 'value' => $hero->title, 'icon' => 'M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z'],
                            ['label' => 'Subtitle', 'value' => $hero->subtitle ?: '—', 'icon' => 'M3.75 9h16.5m-16.5 6.75h16.5'],
                            ['label' => 'Button Text', 'value' => $hero->btn_text ?: '—', 'icon' => 'M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zm-7.518-.267A8.25 8.25 0 1120.25 10.5M8.288 14.212A5.25 5.25 0 1117.25 10.5'],
                            ['label' => 'Button URL', 'value' => $hero->btn_url ?: '—', 'icon' => 'M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244'],
                        ];
                    @endphp
                    @foreach($fields as $f)
        ...
        <div class="xl:col-span-1">
            <div class="craftable-card p-5">
                <div class="flex items-center gap-3 mb-4 pb-4 border-b border-slate-100">
                    ...
                    <h3 class="text-sm font-bold text-slate-700">Hero Image</h3>
                </div>
                ...
                @else
                    <div class="aspect-[4/5] bg-gradient-to-br from-slate-50 to-indigo-50/30 border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center text-slate-400 gap-2">
                        ...
                        <span class="text-xs font-semibold text-slate-400">No image uploaded</span>
                        <a href="{{ route('admin.hero.edit', $hero->id) }}" class="text-xs text-violet-500 hover:text-violet-700 font-semibold transition-colors">Add an image →</a>
                    </div>
                @endif
            </div>
        </div>
