    ...
    <section class="relative pt-40 pb-32 overflow-hidden bg-zinc-50 dark:bg-slate-950 transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                ...
                {{-- Contact Info --}}
                <div>
                    <span class="hero-fade-in block text-sm font-semibold uppercase tracking-widest text-primary-600 mb-6" style="animation-delay:0.1s">Contact Me</span>
                    <h1 class="hero-fade-in text-5xl sm:text-7xl font-bold tracking-tight text-slate-900 dark:text-white mb-8 leading-tight" style="animation-delay:0.2s">
                        Let's Talk <br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-indigo-400 dark:from-primary-400 dark:to-indigo-300">Digital.</span>
                    </h1>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-center gap-6 group">
                            ...
                            <div>
                                <h4 class="text-xs uppercase tracking-widest font-black text-slate-400 dark:text-slate-600 mb-1">Email Details</h4>
                        ...
                        <div class="flex items-center gap-6 group">
                            ...
                            <div>
                                <h4 class="text-xs uppercase tracking-widest font-black text-slate-400 dark:text-slate-600 mb-1">Office Location</h4>
                                <p class="text-lg font-bold text-slate-900 dark:text-white">Remote / Worldwide</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-[3rem] p-10 md:p-14 border border-slate-200 dark:border-slate-800 shadow-premium relative">
                        <form action="#" method="POST" class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-600 mb-3 ml-2">Your Name</label>
                                    <input type="text" placeholder="John Doe" class="w-full bg-zinc-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl px-6 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-600 mb-3 ml-2">Email Address</label>
                            ...
                            <div>
                                <label class="block text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-600 mb-3 ml-2">Subject</label>
                                <input type="text" placeholder="General Inquiry" class="w-full bg-zinc-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl px-6 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all">
                            </div>
                            <div>
                                <label class="block text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-600 mb-3 ml-2">Message</label>
                                <textarea rows="6" placeholder="Tell me about your project..." class="w-full bg-zinc-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl px-6 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all"></textarea>
                            </div>
