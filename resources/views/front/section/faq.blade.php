...
<section class="py-32 relative overflow-hidden">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20" x-data="{ intersecting: false }" x-intersect.once="intersecting = true" :class="intersecting ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'">
            <span class="text-primary-600 font-semibold uppercase tracking-widest text-[10px] mb-4 block">{{ __('Quick Answers') }}</span>
        ...
        <div class="space-y-4" x-data="{ active: null }">
            @php
                $faqs = [
                    ['q' => __('What technologies do you specialize in?'), 'a' => __('I specialize in the TALL stack (Tailwind, Alpine.js, Laravel, Livewire) as well as Vue.js, React, and high-performance backend architecture with MySQL and Redis.')],
                    ['q' => __('How long does a typical project take?'), 'a' => __('A small portfolio or landing page usually takes 1-2 weeks. More complex SaaS applications or platforms take 4-12 weeks depending on features.')],
                    ['q' => __('Do you offer ongoing maintenance?'), 'a' => __('Yes, I provide monthly maintenance packages to ensure your application remains secure, up-to-date, and performing at its peak.')],
                ];
            @endphp
